...
type (
	...
	SearchArticleRequest  = pb.SearchArticleRequest
	SearchArticleResponse = pb.SearchArticleResponse
...
func (m *defaultArticle) SearchArticle(ctx context.Context, in *SearchArticleRequest, opts ...grpc.CallOption) (*SearchArticleResponse, error) {
	client := pb.NewArticleClient(m.cli.Conn())
