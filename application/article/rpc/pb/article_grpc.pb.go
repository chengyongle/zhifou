...
type ArticleClient interface {
	...
	SearchArticle(ctx context.Context, in *SearchArticleRequest, opts ...grpc.CallOption) (*SearchArticleResponse, error)
}
...
func (c *articleClient) SearchArticle(ctx context.Context, in *SearchArticleRequest, opts ...grpc.CallOption) (*SearchArticleResponse, error) {
	out := new(SearchArticleResponse)
	err := c.cc.Invoke(ctx, "/pb.Article/SearchArticle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArticleServer interface {
	...
	SearchArticle(context.Context, *SearchArticleRequest) (*SearchArticleResponse, error)
...
func (UnimplementedArticleServer) SearchArticle(context.Context, *SearchArticleRequest) (*SearchArticleResponse, error) {
...
func _Article_SearchArticle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Article/SearchArticle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServer).SearchArticle(ctx, req.(*SearchArticleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
