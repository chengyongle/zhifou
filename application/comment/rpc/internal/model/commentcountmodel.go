...
func NewCommentCountModel(conn sqlx.SqlConn, c cache.CacheConf, opts ...cache.Option) CommentCountModel {
	return &customCommentCountModel{
		defaultCommentCountModel: newCommentCountModel(conn, c, opts...),
	}
}
